<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginUnidad.aspx.cs" Inherits="ProyectoReciclaje.LoginUnidad" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            Ingresar placas:<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
            <br />
            Ingresar contraseña:
